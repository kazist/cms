...
namespace Cms\Blogs\Code\Controllers;

defined('KAZIST') or exit('Not Kazist Framework');

use Kazist\KazistFactory;
use Kazist\Controller\BaseController;
use Cms\Blogs\Code\Models\BlogsModel;
...
class BlogsController extends BaseController {
    ...
    public function indexAction($offset = 0, $limit = 10) {
        ...
        $this->html = $this->render('Cms:Blogs:Code:views:table.index.twig', $data_arr);
    ...
    public function detailAction() {
        ...
        $rate_enable = $factory->getSetting('cms_blog_rate_enable');
        $addthis_enable = $factory->getSetting('cms_blog_addthis_enable');
        $disqus_enable = $factory->getSetting('cms_blog_disqus_enable');
        $survey_enable = $factory->getSetting('cms_blog_survey_enable');
        ...
        $this->container->get('document')->type = 'blog';

        $this->html = $this->render('Cms:Blogs:Code:views:detail.index.twig', $data_arr);
    ...
    public function editAction() {
        ...
        $this->html = $this->render('Cms:Blogs:Code:views:edit.index.twig', $data_arr);
