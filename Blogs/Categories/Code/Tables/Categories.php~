...
namespace Cms\Blogs\Categories\Code\Tables;
 ...
 * Categories
 *
 * @ORM\Table(name="cms_blogs_categories", indexes={@ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
